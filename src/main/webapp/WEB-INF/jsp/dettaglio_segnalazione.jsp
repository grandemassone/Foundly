...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/dettaglio_segnalazione.css?v=7">
</head>
                        ...
                        <c:otherwise>
                            <div class="sidebar-card">
                                <h3 class="sidebar-title">È tuo questo oggetto?</h3>
                                    ...
                                    <%-- BOX STATO RECLAMO MIGLIORATO (Senza underscore!) --%>
                        ...
                        <c:forEach var="r" items="${reclamiRicevuti}">
                            <div class="claim-card">
                                <div class="claim-header">
                                    <span style="font-weight:700; color:#333;">Richiesta #${r.id}</span>
