...
<%@ page import="model.bean.Segnalazione" %>
...
<%
    ...
    List<Segnalazione> segnalazioni = (List<Segnalazione>) request.getAttribute("listaSegnalazioni");
%>
...
<main class="admin-main">
        ...
        <div class="admin-card">
            ...
            <table class="admin-table">
                ...
                <tr>
                    ...
                    <td><%= dp.getTelefono() != null ? dp.getTelefono() : "-" %>
                    </td>
        ...
        <div class="admin-card" style="margin-top:20px;">
            ...
            <table class="admin-table">
                ...
                <tr>
                    ...
                    <td><%= dp.getEmail() != null ? dp.getEmail() : "-" %>
                    </td>
                    <td><%= dp.getTelefono() != null ? dp.getTelefono() : "-" %>
                    </td>
                    <td class="admin-actions">
    ...
    <section class="admin-section">
        <h1 class="admin-title">Gestione Segnalazioni</h1>

        <div class="admin-card">
            <h2 class="admin-subtitle">Tutte le segnalazioni</h2>

            <%
                if (segnalazioni == null || segnalazioni.isEmpty()) {
            %>
            <p class="admin-empty">Nessuna segnalazione presente.</p>
            <%
            } else {
            %>
            <table class="admin-table">
                ...
                <tr>
                    ...
                    <td><%= s.getTitolo() != null ? s.getTitolo() : "-" %>
                    </td>
                    <td><%= s.getTipoSegnalazione() != null ? s.getTipoSegnalazione() : "-" %>
                    </td>
                    <td><%= s.getStato() != null ? s.getStato() : "-" %>
                    </td>
                    <td><%= s.getIdUtente() %>
                    </td>
                    <td class="admin-actions">
                        <form method="post"
                            ...
                            <input type="hidden" name="action" value="deleteSegnalazione">
                            <input type="hidden" name="segnalazioneId" value="<%= s.getId() %>">
                            <button type="submit" class="btn-admin-delete">Elimina</button>
                        </form>
                    </td>
                </tr>
