    ...
    <div class="info-section">
        ...
        <div class="hero-text">
            ...
            <p>
                ...
                Segnala uno smarrimento, cerca tra i ritrovamenti e restituisci in sicurezza tramite i nostri Drop-Point.
            </p>
        ...
        <div class="auth-card">
            ...
            <form action="${pageContext.request.contextPath}/login" method="post">
                ...
                <div class="form-actions">
                    <a href="${pageContext.request.contextPath}/recupero-password" class="forgot-password">Password dimenticata?</a>
                </div>
            ...
            <div class="registration-area">
                ...
                <div class="reg-buttons">
                    <a href="${pageContext.request.contextPath}/registrazione-utente" class="btn-outline">
                        Registrati come Utente
                    </a>
                    <a href="${pageContext.request.contextPath}/registrazione-droppoint" class="btn-outline">
                        Registrati come Drop Point
                    </a>
                </div>
            </div>
        </div>
